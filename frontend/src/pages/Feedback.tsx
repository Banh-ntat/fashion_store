...
export default function Feedback() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus({ type: "ok", text: "Cảm ơn bạn đã góp ý — chúng tôi đã ghi nhận." });
      setMessage("");
    } catch {
      setStatus({
        type: "err",
  ...
  return (
    <div className="feedback-page">
      <section className="feedback-hero">
        ...
        <div className="feedback-heroBlob feedback-heroBlob--left" aria-hidden />
        <div className="feedback-heroBlob feedback-heroBlob--right" aria-hidden />
        <div className="feedback-heroInner">
          ...
          <p className="feedback-heroLead">
            Mỗi ý kiến đều quý — từ giao diện, tốc độ tải đến cách chúng tôi hỗ trợ bạn.
          </p>
          ...
          <div className="feedback-tipCard feedback-tipCard--a">
            <div className="feedback-tipIcon" aria-hidden>
              <svg viewBox="0 0 32 32" fill="none">
                ...
                />
                <path d="M12 22v4h8v-4" stroke="currentColor" strokeWidth="1.8" />
                <path d="M16 6v4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
              </svg>
            </div>
            <div>
              <h3 className="feedback-tipTitle">Góp ý chung</h3>
              <p className="feedback-tipText">
                Nhận xét về cửa hàng, giao diện, cách phục vụ — lưu theo tài khoản khi đã đăng nhập.
              </p>
            </div>
          </div>
            ...
            <div className="feedback-tipIcon" aria-hidden>
              <svg viewBox="0 0 32 32" fill="none">
                <path
                  ...
                  strokeWidth="1.8"
                />
                <path d="M10 12V8a6 6 0 0112 0v4" stroke="currentColor" strokeWidth="1.8" />
              ...
              <div className="feedback-guestCard">
                <div className="feedback-guestArt" aria-hidden>
                  <svg viewBox="0 0 120 120" className="feedback-guestSvg">
                    ...
                    <circle cx="60" cy="60" r="52" fill="url(#fbGrad)" opacity="0.15" />
                    <path
                    ...
                    <path
                      ...
                      strokeLinecap="round"
                    />
                    <circle cx="75" cy="42" r="8" fill="url(#fbGrad)" opacity="0.9" />
                    <path
                      d="M72 42l3 3 6-6"
                      stroke="#fff"
                      strokeWidth="2"
                ...
                <p className="feedback-guestText">
                  Chúng tôi gắn góp ý với tài khoản để xử lý minh bạch và phản hồi đúng người.
                </p>
                <div className="feedback-guestActions">
                  ...
                  <Link to="/register" className="feedback-btn feedback-btn--ghost">
                    Tạo tài khoản
                  </Link>
                </div>
              </div>
                ...
                <div className="feedback-formHead">
                  <div>
                    ...
                    <p className="feedback-formHint">
                      Xin chào <strong>{user.username}</strong> — viết tự do, chúng tôi đọc hết.
                    </p>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="feedback-form">
                  <div className="feedback-field">
                    <div className="feedback-fieldLabelRow">
                      ...
                      <span className={`feedback-count ${len > MAX_LEN ? "is-over" : ""}`}>
                        {len} / {MAX_LEN}
                      </span>
                    </div>
