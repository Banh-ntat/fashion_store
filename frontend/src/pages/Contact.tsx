  ...
  return (
    <div className="contact-page">
      <section className="contact-hero">
        ...
        <div className="contact-hero-blob contact-hero-blob--left" aria-hidden />
        <div className="contact-hero-blob contact-hero-blob--right" aria-hidden />
        <div className="contact-hero-inner">
          ...
          <p className="contact-hero-lead">
            Gửi câu hỏi hoặc yêu cầu — chúng tôi phản hồi qua email, thường trong 1–2 ngày làm việc.
            Cần gấp về đơn đang giao? Gọi hotline trong giờ làm việc.
          </p>
          <div
            ...
            <div className="contact-formCard">
              <div className="contact-formHead">
                <div>
                  ...
                  <p className="contact-formHint">Các trường có dấu * là bắt buộc.</p>
                </div>
                <div className="contact-formHeadIcon" aria-hidden>
                  <svg viewBox="0 0 32 32" fill="none">
                    ...
                    />
                    <path d="M6 14l10 6 10-6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
                  </svg>
                </div>
              </div>
