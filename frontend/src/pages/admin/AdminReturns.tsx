...
export default function AdminReturns() {
  ...
  if (loading) {
    return <AdminLayout><div className="loading">Đang tải...</div></AdminLayout>;
  }
          ...
          <tbody>
            {rows.length === 0 ? (
              ...
              <tr key={r.id}>
                ...
                <td>
                  <button type="button" className="btn-secondary btn-sm" onClick={() => openDetail(r)}>
                    Chi tiết
                  </button>
                </td>
              </tr>
        ...
        {detail && (
          <div className="modal-overlay" role="dialog" aria-modal="true">
            <div className="modal modal--wide">
              ...
              <p><strong>Khách hàng:</strong> {detail.username}</p>
              <p><strong>Đơn hàng:</strong> #{detail.order} — Tổng: {Number(detail.order_total).toLocaleString('vi-VN')}đ</p>
              ...
              <p>
                ...
                <span className={`status-badge ${STATUS_BADGE[detail.status] ?? ''}`}>
                  {STATUS_LABEL[detail.status] ?? detail.status}
                </span>
              </p>
              <p><strong>Ngày gửi:</strong> {new Date(detail.created_at).toLocaleString('vi-VN')}</p>
              ...
              {detail.status === 'pending' && (
                <div style={{ marginTop: '16px' }}>
                  ...
                  />
                  {actionError && (
                    <p style={{ color: '#b91c1c', fontSize: '0.88rem', marginBottom: '10px' }}>{actionError}</p>
                  )}
              ...
              {detail.admin_note && detail.status !== 'pending' && (
                <div style={{ marginTop: '14px', padding: '10px 14px', background: '#eff6ff', borderLeft: '3px solid #3b82f6', borderRadius: '0 6px 6px 0', fontSize: '0.9rem' }}>
